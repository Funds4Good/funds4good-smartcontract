...
pub enum Funds4GoodError {
    ...
    AmountOverflow,
    /// Account Not Owned By Fund4Good
    #[error("Account Not Owned By Funds4Good Program")]
    WrongAccountPassed,
    ...
    AdminDoesNotMatched,
    /// Funds4Good Vault Account Does Not Matched
    #[error("Funds4Good Vault Account Does Not Matched")]
    Funds4GoodVaultAccountDoesNotMatched,
...
impl From<Funds4GoodError> for ProgramError {
    fn from(e: Funds4GoodError) -> Self {
